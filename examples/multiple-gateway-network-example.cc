...
NS_LOG_COMPONENT_DEFINE ("MultipleGatewayLorawanNetworkExample");

// Network settings
int nDevices = 200;
int nGateways = 4;
double radius = 18000; //Note that due to model updates, 7500 m is no longer the maximum distance
...
main (int argc, char *argv[])
{
  ...
  // Set up logging
  LogComponentEnable ("MultipleGatewayLorawanNetworkExample", LOG_LEVEL_ALL);
